...
Thanks for your interest! This project is early-stage (currently 544/794 planned public names
across fifteen implemented modules),
...
spl --test      # embedded self-check suite (187 checks, no pytest needed)
```
