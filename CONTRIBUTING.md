...
Thanks for your interest! This project is early-stage (currently 660/794 planned public names
across nineteen implemented modules),
...
spl --test      # embedded self-check suite (235 checks, no pytest needed)
```
