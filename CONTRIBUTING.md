...
Thanks for your interest! This project is early-stage (currently 689/794 planned public names
across twenty implemented modules),
...
spl --test      # embedded self-check suite (250 checks, no pytest needed)
```
