...
Thanks for your interest! This project is early-stage (currently 628/794 planned public names
across eighteen implemented modules),
...
spl --test      # embedded self-check suite (222 checks, no pytest needed)
```
