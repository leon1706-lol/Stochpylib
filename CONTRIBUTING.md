...
Thanks for your interest! This project is early-stage (currently 506/794 planned public names
across fourteen implemented modules),
...
spl --test      # embedded self-check suite (177 checks, no pytest needed)
```
