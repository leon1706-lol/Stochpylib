...
Thanks for your interest! This project is early-stage (currently 400/794 planned public names
across eleven implemented modules),
...
spl --test      # embedded self-check suite (152 checks, no pytest needed)
```
