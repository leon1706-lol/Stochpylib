...
Thanks for your interest! This project is early-stage (currently 721/794 planned public names
across twenty-one implemented modules),
...
spl --test      # embedded self-check suite (264 checks, no pytest needed)
```
