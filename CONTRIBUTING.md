...
Thanks for your interest! This project is early-stage (currently 350/794 planned public names
across ten implemented modules),
...
spl --test      # embedded self-check suite (145 checks, no pytest needed)
```
