...
IMPLEMENTED = (
    ...
    "bayesian", "robust_statistics", "nonparametric", "optimization",
...
def test_no_stale_claims_in_readme():
    ...
    for stale in (r"\b288\b", r"\b287\b", r"\b496\b", r"\b329\b", r"\b257\b",
                  ...
                  r"\b160-check\b", r"\btwelve modules\b", r"\b471\b",
                  r"\b1447 passed\b", r"\b1447 passing\b", r"\b168 checks\b",
                  r"\b168-check\b", r"\bthirteen modules\b", r"\b506\b",
                  ...
                  r"\b199-check\b", r"\bsixteen modules\b", r"\b597\b",
                  r"\b1911 passed\b", r"\b1911 passing\b", r"\b212 checks\b",
                  r"\b212-check\b", r"\bseventeen modules\b",
                  r"\b628\b", r"\b2016 passed\b", r"\b2016 passing\b", r"\b222 checks\b",
                  r"\b222-check\b", r"\beighteen modules\b",
                  r"\b660\b", r"\b2201 passed\b", r"\b2201 passing\b", r"\b235 checks\b",
                  r"\b235-check\b", r"\bnineteen modules\b",
                  r"\b689\b", r"\b2371 passed\b", r"\b2371 passing\b", r"\b250 checks\b",
                  r"\b250-check\b", r"\btwenty modules\b",
                  r"\b721\b", r"\b2520 passed\b", r"\b2520 passing\b", r"\b264 checks\b",
                  r"\b264-check\b", r"\btwenty-one modules\b"):
...
def test_implementation_checklist_progress_line_matches_reality():
    ...
    assert total_done == expected_total == 756, (
