...
│   ├── __init__.py              # re-exports all twenty subpackages; __version__
...
│   ├── cli_demo.py              # the twenty live mini-examples behind spl demo
│   ├── selftest.py              # embedded 250-check self-check suite shipped in the wheel
...
│   ├── <module>/tests.py        # one deterministic oracle suite per implemented module (twenty)
...
│   ├── Implementation-Checklist.md  # every planned public name as a checkbox (689/794 done)
