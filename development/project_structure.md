...
│   ├── __init__.py              # re-exports all fifteen subpackages; __version__
...
│   ├── cli_demo.py              # the fifteen live mini-examples behind spl demo
│   ├── selftest.py              # embedded 187-check self-check suite shipped in the wheel
...
│   ├── <module>/tests.py        # one deterministic oracle suite per implemented module (fifteen)
...
│   ├── Implementation-Checklist.md  # every planned public name as a checkbox (544/794 done)
