...
│   ├── __init__.py              # re-exports all sixteen subpackages; __version__
...
│   ├── cli_demo.py              # the sixteen live mini-examples behind spl demo
│   ├── selftest.py              # embedded 199-check self-check suite shipped in the wheel
...
│   ├── <module>/tests.py        # one deterministic oracle suite per implemented module (sixteen)
...
│   ├── Implementation-Checklist.md  # every planned public name as a checkbox (569/794 done)
