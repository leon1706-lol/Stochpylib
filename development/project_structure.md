...
│   ├── __init__.py              # re-exports all fourteen subpackages; __version__
...
│   ├── cli_demo.py              # the fourteen live mini-examples behind spl demo
│   ├── selftest.py              # embedded 177-check self-check suite shipped in the wheel
...
│   ├── <module>/tests.py        # one deterministic oracle suite per implemented module (fourteen)
...
│   ├── Implementation-Checklist.md  # every planned public name as a checkbox (506/794 done)
