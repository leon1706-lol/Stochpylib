...
│   ├── __init__.py              # re-exports all thirteen subpackages; __version__
...
│   ├── cli_demo.py              # the thirteen live mini-examples behind spl demo
│   ├── selftest.py              # embedded 168-check self-check suite shipped in the wheel
...
│   ├── <module>/tests.py        # one deterministic oracle suite per implemented module (thirteen)
...
│   ├── Implementation-Checklist.md  # every planned public name as a checkbox (471/794 done)
