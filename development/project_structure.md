...
│   ├── __init__.py              # re-exports all twelve subpackages; __version__
...
│   ├── cli_demo.py              # the twelve live mini-examples behind spl demo
│   ├── selftest.py              # embedded 160-check self-check suite shipped in the wheel
...
│   ├── <module>/tests.py        # one deterministic suite per implemented module (twelve)
...
│   ├── Implementation-Checklist.md  # every planned public name as a checkbox (448/794 done)
