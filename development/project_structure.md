...
│   ├── __init__.py              # re-exports all twenty-one subpackages; __version__
...
│   ├── cli_demo.py              # the twenty-one live mini-examples behind spl demo
│   ├── selftest.py              # embedded 264-check self-check suite shipped in the wheel
...
│   ├── <module>/tests.py        # one deterministic oracle suite per implemented module (twenty-one)
...
│   ├── Implementation-Checklist.md  # every planned public name as a checkbox (721/794 done)
