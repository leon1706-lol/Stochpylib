...
| [`Implementation-Checklist.md`](Implementation-Checklist.md) | Every planned module/submodule/public name as checkboxes — the single-glance progress tracker (currently 597/794). Update it whenever you implement |
...
`random_matrix`, `advanced_mcmc`, `numerical_methods`, `bayesian` and
`robust_statistics` are complete and tested (597/794 spec names across
seventeen modules); all other modules are still planned — see the checklist
