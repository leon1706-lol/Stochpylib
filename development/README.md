...
| [`Implementation-Checklist.md`](Implementation-Checklist.md) | Every planned module/submodule/public name as checkboxes — the single-glance progress tracker (currently 689/794). Update it whenever you implement |
...
`robust_statistics`, `nonparametric`, `optimization` and `experimental_design` are
complete and tested (689/794 spec names across twenty modules); all other modules are still
planned — see the
