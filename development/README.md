...
| [`Implementation-Checklist.md`](Implementation-Checklist.md) | Every planned module/submodule/public name as checkboxes — the single-glance progress tracker (currently 660/794). Update it whenever you implement |
...
`robust_statistics`, `nonparametric` and `optimization` are complete and tested
(660/794 spec names across nineteen modules); all other modules are still planned — see the
