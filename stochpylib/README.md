...
shared result object. Twenty-two subpackages live today (756/794 spec names):
...
| `viz/` | 35 | SVG-native statistical plots (matplotlib optional): distribution/process/diagnostic/multivariate/special-purpose plots, reusing the rest of the library's own numbers | [README](viz/README.md) |
...
- `cli_demo.py` — the twenty-two live mini-examples behind `spl demo <module>`.
- `selftest.py` — the 275-check self-check suite shipped inside the wheel,
