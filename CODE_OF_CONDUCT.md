...
This Code of Conduct applies within all project spaces — code repository, issue tracker,
pull requests, and any other communication channels operated by the project — and also applies
when an individual is officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
project maintainer at **leonschwarzkopf08@gmail.com** or via GitHub's report mechanism on the
