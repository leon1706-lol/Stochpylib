...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-848%20passing-brightgreen?style=flat-square&labelColor=1A1A1A" alt="848 of 850 tests passing">
  ...
  <img src="https://img.shields.io/badge/public%20names-448%20of%20794-FF8C00?style=flat-square&labelColor=1A1A1A" alt="448 of 794 spec names implemented">
</p>
...
confidence interval. Around that contract, twelve modules are live today: a **probability
...
clustering/MDS). The roadmap takes
...
- **PyPI lags the repository.** The latest published release is `0.1.1`; the code here is at
  `0.9.0`. Releases are tag-triggered (see [Release Process](#release-process)) and no tag has
...
- **11 of 23 planned modules remain.** The implemented twelve are complete and tested against
...
Twelve modules implemented and tested — **448 / 794 spec names**:
...
(currently **448 / 794 public names**).
...
|---|---|---|
| `stochpylib/` | [package guide](stochpylib/README.md) | the installable package: twelve module subpackages, `cli.py`, `selftest.py` |
...
**848 passed / 2 skipped** as of the V0.9.0 `statistics` implementation (the 2 permanent skips
...
Runs the embedded self-check suite shipped inside the wheel (**160 checks**): package sanity and per-module spec
...
pricing + historical VaR, descriptive stats + t-test + OLS regression + PCA). Bare
...
Eleven modules remain on the spec (in rough implementation order):
