...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1911%20passing-brightgreen?style=flat-square&labelColor=1A1A1A" alt="1911 of 1913 tests passing">
  ...
  <img src="https://img.shields.io/badge/public%20names-597%20of%20794-FF8C00?style=flat-square&labelColor=1A1A1A" alt="597 of 794 spec names implemented">
</p>
...
confidence interval. Around that contract, seventeen modules are live today: a **probability
...
constant-correlation shrinkage, and robust/wild/block/stationary bootstraps). The roadmap
takes it onward through nonparametric methods and beyond (23 modules, ~794 public names planned). The
...
- **PyPI lags the repository.** The latest published release is `0.1.1`; the code here is at
  `0.14.0`. Releases are tag-triggered (see [Release Process](#release-process)) and no tag has
...
- **6 of 23 planned modules remain.** The implemented seventeen are complete and tested against
...
spl --test                  # embedded self-check (212 checks), no pytest needed
```
...
Seventeen modules implemented and tested — **597 / 794 spec names**:
...
(currently **597 / 794 public names**).
...
|---|---|---|
| `stochpylib/` | [package guide](stochpylib/README.md) | the installable package: seventeen module subpackages, `cli.py`, `selftest.py` |
...
**1911 passed / 2 skipped** as of the V0.14.0 `robust_statistics` implementation (the 2 permanent skips
...
Runs the embedded self-check suite shipped inside the wheel (**212 checks**): package sanity and per-module spec
...
block-bootstrap standard error). Bare `spl demo` lists the available demos.
...
Six modules remain on the spec (in rough implementation order): nonparametric methods,
